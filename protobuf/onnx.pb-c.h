...
typedef operator_status (*operator_preparer)(Onnx__NodeProto *ctx);
typedef operator_status (*operator_executer)(Onnx__NodeProto *ctx);
typedef operator_executer (*operator_resolver)(Onnx__NodeProto *ctx);
