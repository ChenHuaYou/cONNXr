 ...
 * @since version 2
 *
 * @see io/onnx/onnx/defs/traditionalml/defs.cc:459
...
typedef struct {
    ...
    char* default_string;
    size_t n_keys_floats;
    float* keys_floats;
    size_t n_keys_int64s;
    int64_t* keys_int64s;
    size_t n_keys_strings;
    char** keys_strings;
    size_t n_values_floats;
    float* values_floats;
    size_t n_values_int64s;
    int64_t* values_int64s;
    size_t n_values_strings;
    char** values_strings;
