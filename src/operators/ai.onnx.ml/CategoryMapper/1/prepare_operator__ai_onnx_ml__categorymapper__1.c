...
)
{
    ...
    // context_operator__ai_onnx_ml__categorymapper__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx_ml__categorymapper__1));
    ...
    // ctx->executer = resolve_operator__ai_onnx_ml__categorymapper__1(ctx);
