...
)
{
    ...
    // context_operator__ai_onnx_ml__normalizer__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx_ml__normalizer__1));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    // op_ctx->norm = a_norm?strndup((char*)a_norm->s.data, a_norm->s.len):default_norm;
    ...
    // ctx->executer = resolve_operator__ai_onnx_ml__normalizer__1(ctx);
