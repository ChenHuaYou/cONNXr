 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/traditionalml/defs.cc:316
...
typedef struct {
    size_t n_imputed_value_floats;
    float* imputed_value_floats;
    size_t n_imputed_value_int64s;
    int64_t* imputed_value_int64s;
    float replaced_value_float;
    int64_t replaced_value_int64;
