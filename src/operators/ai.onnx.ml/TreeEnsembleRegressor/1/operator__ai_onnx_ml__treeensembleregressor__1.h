 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/traditionalml/defs.cc:1116
...
typedef struct {
    ...
    size_t n_target_ids;
    int64_t* target_ids;
    size_t n_target_nodeids;
    int64_t* target_nodeids;
    size_t n_target_treeids;
    int64_t* target_treeids;
    size_t n_target_weights;
