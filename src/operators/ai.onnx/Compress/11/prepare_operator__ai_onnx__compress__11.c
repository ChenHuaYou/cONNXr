...
)
{
    ...
    // Onnx__TensorProto *i_condition = searchInputByName(ctx, 1);
    ...
    // context_operator__ai_onnx__compress__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__compress__11));
    ...
    // ctx->executer = resolve_operator__ai_onnx__compress__11(ctx);
