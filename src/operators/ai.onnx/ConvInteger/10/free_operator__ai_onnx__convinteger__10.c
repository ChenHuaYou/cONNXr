...
void
free_operator__ai_onnx__convinteger__10(
    node_context *ctx
)
{
    TRACE_ENTRY(1);
    ...
    // Onnx__TensorProto *i_w_zero_point = searchInputByName(ctx, 3);
    ...
    // context_operator__ai_onnx__convinteger__10 *op_ctx = ctx->executer_context;
