...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXUNPOOL__9_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXUNPOOL__9_H
...
/**
 * ai.onnx operator 'MaxUnpool' version 9
 *
 ...
 * @since version 9
 *
 * @see io/onnx/onnx/defs/nn/old.cc:712
...
extern operator_info info_operator__ai_onnx__maxunpool__9;
...
} context_operator__ai_onnx__maxunpool__9;
...
operator_status
execute_operator__ai_onnx__maxunpool__9(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxunpool__9__T1_tensor_double__T2_tensor_int64(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__maxunpool__9__T1_tensor_float16__T2_tensor_int64(
    node_context *ctx
);
