...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXUNPOOL__11_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXUNPOOL__11_H
...
/**
 * ai.onnx operator 'MaxUnpool' version 11
 *
 ...
 * @since version 11
 *
 * @see io/onnx/onnx/defs/nn/defs.cc:539
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#MaxUnpool
 */

operator_status
prepare_operator__ai_onnx__maxunpool__11(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__maxunpool__11;
...
} context_operator__ai_onnx__maxunpool__11;
...
operator_status
execute_operator__ai_onnx__maxunpool__11(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxunpool__11__T1_tensor_double__T2_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxunpool__11__T1_tensor_float__T2_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxunpool__11__T1_tensor_float16__T2_tensor_int64(
    node_context *ctx
);
