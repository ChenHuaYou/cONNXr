...
)
{
    ...
    Onnx__TensorProto *o_shape = searchOutputByIndex(ctx, 0);

    /* ALLOCATE AND INITIALIZE CONTEXT HERE IF NEEDED */

    

    // context_operator__ai_onnx__shape__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__shape__1));
    ...
    ctx->executer = execute_operator__ai_onnx__shape__1;
