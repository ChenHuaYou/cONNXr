...
)
{
    ...
    // context_operator__ai_onnx__dequantizelinear__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__dequantizelinear__10));
    ...
    ctx->executer = execute_operator__ai_onnx__dequantizelinear__10;
