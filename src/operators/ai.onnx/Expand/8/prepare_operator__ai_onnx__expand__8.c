...
)
{
    ...
    // context_operator__ai_onnx__expand__8 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__expand__8));
    ...
    // ctx->executer = resolve_operator__ai_onnx__expand__8(ctx);
