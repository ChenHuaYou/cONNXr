...
)
{
    ...
    // context_operator__ai_onnx__resize__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__resize__10));
    ...
    // ctx->executer = resolve_operator__ai_onnx__resize__10(ctx);
