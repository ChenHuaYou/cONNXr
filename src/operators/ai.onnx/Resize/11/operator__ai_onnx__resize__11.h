 ...
 *   'X'. Only one of 'scales' and 'sizes' can be specified. If 'size' is
 ...
 *   be the same as the rank of input 'X'. Only one of 'scales' and 'sizes' can
 *   be specified.
...
* @since version 11
*
 * @see io/onnx/onnx/defs/tensor/defs.cc:1812
