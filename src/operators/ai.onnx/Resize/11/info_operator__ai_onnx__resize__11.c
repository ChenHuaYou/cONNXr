...
static
uint32_t
input_tensor_type_scales[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT
};

static
uint32_t
input_tensor_type_sizes[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__INT64
};
...
},
{
    ...
    .n_types     = 1,
    .types       = input_tensor_type_scales
},
{
    .name        = "sizes",
    .optional    = true,
...
/* operator info */
operator_info
info_operator__ai_onnx__resize__11 = {
    .name         = "Resize",
    .range_input  = { 3, 4 },
    .range_output = { 1, 1 },
    .n_attribute  = 6,
