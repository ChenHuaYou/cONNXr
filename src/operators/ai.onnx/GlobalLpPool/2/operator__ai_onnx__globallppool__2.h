...
# ifndef OPERATOR_OPERATOR__AI_ONNX__GLOBALLPPOOL__2_H
# define OPERATOR_OPERATOR__AI_ONNX__GLOBALLPPOOL__2_H
...
/**
 * ai.onnx operator 'GlobalLpPool' version 2
 *
 ...
 * @since version 2
 *
 * @see io/onnx/onnx/defs/nn/defs.cc:1492
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#GlobalLpPool
 */

operator_status
prepare_operator__ai_onnx__globallppool__2(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__globallppool__2;

typedef struct {
    int64_t p;

} context_operator__ai_onnx__globallppool__2;

operator_executer
resolve_operator__ai_onnx__globallppool__2(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__globallppool__2(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__globallppool__2__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__globallppool__2__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__globallppool__2__T_tensor_float16(
    node_context *ctx
);
