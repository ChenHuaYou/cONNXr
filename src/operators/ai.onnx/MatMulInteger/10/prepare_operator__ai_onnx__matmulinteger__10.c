...
)
{
    ...
    //Onnx__TensorProto *i_b_zero_point = searchInputByIndex(ctx, 3);
    ...
    // context_operator__ai_onnx__matmulinteger__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__matmulinteger__10));
    ...
    ctx->executer = execute_operator__ai_onnx__matmulinteger__10;
