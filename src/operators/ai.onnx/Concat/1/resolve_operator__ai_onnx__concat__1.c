...
case ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT16: { executer = (operator_executer) &execute_operator__ai_onnx__concat__1__T_tensor_float16; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__concat__1 and constraint 'T' with type '%s' found!\n",operator_info_tensorType2str(T));
        break;
    }
}
}
