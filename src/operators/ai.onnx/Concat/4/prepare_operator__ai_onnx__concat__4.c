...
)
{
    ...
    // context_operator__ai_onnx__concat__4 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__concat__4));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    // op_ctx->axis = a_axis->i;
    ...
    // ctx->executer = resolve_operator__ai_onnx__concat__4(ctx);
