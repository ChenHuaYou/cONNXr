...
operator_status
execute_operator__ai_onnx__asinh__9__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__asinh__9__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__asinh__9__T_tensor_float16(
    node_context *ctx
);
