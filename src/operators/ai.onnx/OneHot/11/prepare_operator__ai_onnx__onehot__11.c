...
)
{
    ...
    //Onnx__TensorProto *i_indices = searchInputByIndex(ctx, 0);
    //Onnx__TensorProto *i_depth = searchInputByIndex(ctx, 1);
    //Onnx__TensorProto *i_values = searchInputByIndex(ctx, 2);
    ...
    // context_operator__ai_onnx__onehot__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__onehot__11));
    ...
    ctx->executer = execute_operator__ai_onnx__onehot__11;
