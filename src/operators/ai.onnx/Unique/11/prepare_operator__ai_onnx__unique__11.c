...
)
{
    ...
    Onnx__TensorProto *o_inverse_indices = searchOutputByIndex(ctx, 2);
    Onnx__TensorProto *o_counts = searchOutputByIndex(ctx, 3);
    ...
    // context_operator__ai_onnx__unique__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__unique__11));
    ...
    mallocTensorData(o_inverse_indices);
    mallocTensorData(o_counts);
    ...
    ctx->executer = execute_operator__ai_onnx__unique__11;
