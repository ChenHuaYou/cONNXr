...
# ifndef OPERATOR_OPERATOR__AI_ONNX__NONMAXSUPPRESSION__10_H
# define OPERATOR_OPERATOR__AI_ONNX__NONMAXSUPPRESSION__10_H
...
/**
 * ai.onnx operator 'NonMaxSuppression' version 10
 *
...
* @since version 10
*
 * @see io/onnx/onnx/defs/object_detection/old.cc:71
...
extern operator_info info_operator__ai_onnx__nonmaxsuppression__10;

typedef struct {
    int64_t center_point_box;

} context_operator__ai_onnx__nonmaxsuppression__10;
