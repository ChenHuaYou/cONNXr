...
# ifndef OPERATOR_OPERATOR__AI_ONNX__GEMM__11_H
# define OPERATOR_OPERATOR__AI_ONNX__GEMM__11_H
...
/**
 * ai.onnx operator 'Gemm' version 11
 *
 ...
 * @since version 11
 *
 * @see io/onnx/onnx/defs/math/defs.cc:935
...
extern operator_info info_operator__ai_onnx__gemm__11;
...
} context_operator__ai_onnx__gemm__11;
...
operator_status
execute_operator__ai_onnx__gemm__11(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_double(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__11__T_tensor_uint64(
    node_context *ctx
);
