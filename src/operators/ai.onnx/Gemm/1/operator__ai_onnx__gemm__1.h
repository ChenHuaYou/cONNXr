...
# ifndef OPERATOR_OPERATOR__AI_ONNX__GEMM__1_H
# define OPERATOR_OPERATOR__AI_ONNX__GEMM__1_H
...
/**
 * ai.onnx operator 'Gemm' version 1
 *
 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/math/old.cc:992
...
extern operator_info info_operator__ai_onnx__gemm__1;
...
} context_operator__ai_onnx__gemm__1;
...
operator_status
execute_operator__ai_onnx__gemm__1(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__1__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__1__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__gemm__1__T_tensor_float16(
    node_context *ctx
);
