...
)
{
    ...
    // context_operator__ai_onnx__gather__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__gather__1));
    ...
    ctx->executer = execute_operator__ai_onnx__gather__1;
