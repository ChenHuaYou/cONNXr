...
)
{
    ...
    //Onnx__TensorProto *i_tiles = searchInputByIndex(ctx, 1);
    //Onnx__TensorProto *i_axis = searchInputByIndex(ctx, 2);
    ...
    // context_operator__ai_onnx__tile__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__tile__1));
    ...
    ctx->executer = execute_operator__ai_onnx__tile__1;
