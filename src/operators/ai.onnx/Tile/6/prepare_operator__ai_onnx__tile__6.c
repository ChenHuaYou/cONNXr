...
)
{
    ...
    // Onnx__TensorProto *i_repeats = searchInputByName(ctx, 1);

    // TRACE_TENSOR(2, true, i_input);
    // TRACE_TENSOR(2, true, i_repeats);
    ...
    // context_operator__ai_onnx__tile__6 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__tile__6));
    ...
    // ctx->executer = resolve_operator__ai_onnx__tile__6(ctx);
