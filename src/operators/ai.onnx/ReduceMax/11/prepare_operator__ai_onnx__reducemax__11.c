...
)
{
    ...
    // context_operator__ai_onnx__reducemax__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__reducemax__11));
    ...
    // ctx->executer = resolve_operator__ai_onnx__reducemax__11(ctx);
