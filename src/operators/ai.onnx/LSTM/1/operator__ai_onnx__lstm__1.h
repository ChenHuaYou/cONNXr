...
# ifndef OPERATOR_OPERATOR__AI_ONNX__LSTM__1_H
# define OPERATOR_OPERATOR__AI_ONNX__LSTM__1_H
...
/**
 * ai.onnx operator 'LSTM' version 1
 *
 ...
 * 
 * Input T R:
 *   The recurrence weight tensor. Concatenation of `R[iofc]` and `RB[iofc]`
 ...
 * 
 * Input T P:
 *   The weight tensor for peepholes. Concatenation of `P[iof]` and `PB[iof]`
 *   (if bidirectional) along dimension 0. It has shape `[num_directions,
 *   3*hidde_size]`. Optional: If not specified - assumed to be 0.
 *   Allowed Types: tensor_double, tensor_float, tensor_float16
 * Output T Y:
 *   A tensor that concats all the intermediate output values of the hidden.
 *   It has shape `[seq_length, num_directions, batch_size, hidden_size]`. It
 *   is optional if `output_sequence` is 0.
 *   Allowed Types: tensor_double, tensor_float, tensor_float16
 * 
 * Output T Y_h:
 ...
 *   output, forget, cell, and hidden. The activation functions must be one of
 *   the activation functions specified above. Optional: See the equations for
 ...
 * 
 * Attribute INT input_forget (optional):
 *   Couple the input and forget gates if 1, default 0.
 * 
 * Attribute INT output_sequence (optional):
 *   The sequence output for the hidden is optional if 0. Default 0.
 *
 * @since version 1
 *
 * @see io/onnx/onnx/defs/rnn/old.cc:710
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#LSTM
 */
...
extern operator_info info_operator__ai_onnx__lstm__1;

typedef struct {
    size_t n_activation_alpha;
    float* activation_alpha;
    size_t n_activation_beta;
...
} context_operator__ai_onnx__lstm__1;

operator_executer
resolve_operator__ai_onnx__lstm__1(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__lstm__1__T_tensor_double__T1_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lstm__1__T_tensor_float__T1_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lstm__1__T_tensor_float16__T1_tensor_int32(
    node_context *ctx
);
