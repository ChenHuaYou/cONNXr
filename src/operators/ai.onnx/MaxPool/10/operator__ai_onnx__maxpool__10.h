...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__10_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__10_H
...
/**
 * ai.onnx operator 'MaxPool' version 10
 *
 ...
 * @since version 10
 *
 * @see io/onnx/onnx/defs/nn/old.cc:500
...
extern operator_info info_operator__ai_onnx__maxpool__10;
...
} context_operator__ai_onnx__maxpool__10;
...
operator_status
execute_operator__ai_onnx__maxpool__10(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__10__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__10__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__10__T_tensor_float16(
    node_context *ctx
);
