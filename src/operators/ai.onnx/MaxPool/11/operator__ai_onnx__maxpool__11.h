...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__11_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__11_H
...
/**
 * ai.onnx operator 'MaxPool' version 11
 *
 ...
 * @since version 11
 *
 * @see io/onnx/onnx/defs/nn/old.cc:536
...
extern operator_info info_operator__ai_onnx__maxpool__11;
...
} context_operator__ai_onnx__maxpool__11;
...
operator_status
execute_operator__ai_onnx__maxpool__11(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__11__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__11__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__11__T_tensor_float16(
    node_context *ctx
);
