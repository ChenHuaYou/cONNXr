...
#include "operator__ai_onnx__maxpool__11.h"
#include "tracing.h"
#include "utils.h"

operator_status
prepare_operator__ai_onnx__maxpool__11(
    node_context *ctx
)
{
    TRACE_ENTRY(1);
    ...
    // context_operator__ai_onnx__maxpool__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__maxpool__11));
    ...
    // ctx->executer = resolve_operator__ai_onnx__maxpool__11(ctx);
