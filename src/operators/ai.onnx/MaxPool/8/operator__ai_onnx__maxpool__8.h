...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__8_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__8_H
...
/**
 * ai.onnx operator 'MaxPool' version 8
 *
 ...
 * @since version 8
 *
 * @see io/onnx/onnx/defs/nn/old.cc:464
...
extern operator_info info_operator__ai_onnx__maxpool__8;
...
} context_operator__ai_onnx__maxpool__8;
...
operator_status
execute_operator__ai_onnx__maxpool__8__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__8__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__8__T_tensor_float16(
    node_context *ctx
);
