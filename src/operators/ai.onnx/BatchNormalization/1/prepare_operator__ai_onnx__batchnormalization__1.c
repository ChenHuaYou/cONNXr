...
)
{
    ...
    // op_ctx->n_consumed_inputs = a_consumed_inputs->n_ints;
    // op_ctx->consumed_inputs = a_consumed_inputs->ints;
    ...
    ctx->executer = execute_operator__ai_onnx__batchnormalization__1;
