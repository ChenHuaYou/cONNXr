...
# ifndef OPERATOR_OPERATOR__AI_ONNX__BATCHNORMALIZATION__6_H
# define OPERATOR_OPERATOR__AI_ONNX__BATCHNORMALIZATION__6_H
...
/**
 * ai.onnx operator 'BatchNormalization' version 6
 *
 ...
 * @since version 6
 *
 * @see io/onnx/onnx/defs/nn/old.cc:1658
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#BatchNormalization
 */

operator_status
prepare_operator__ai_onnx__batchnormalization__6(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__batchnormalization__6;
...
} context_operator__ai_onnx__batchnormalization__6;

operator_executer
resolve_operator__ai_onnx__batchnormalization__6(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__batchnormalization__6(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__batchnormalization__6__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__batchnormalization__6__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__batchnormalization__6__T_tensor_float16(
    node_context *ctx
);
