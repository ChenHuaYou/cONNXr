...
)
{
    ...
    // context_operator__ai_onnx__batchnormalization__6 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__batchnormalization__6));
    ...
    // ctx->executer = resolve_operator__ai_onnx__batchnormalization__6(ctx);
