...
)
{
    ...
    //Onnx__TensorProto *i_x_scale = searchInputByIndex(ctx, 1);
    //Onnx__TensorProto *i_x_zero_point = searchInputByIndex(ctx, 2);
    //Onnx__TensorProto *i_w = searchInputByIndex(ctx, 3);
    //Onnx__TensorProto *i_w_scale = searchInputByIndex(ctx, 4);
    //Onnx__TensorProto *i_w_zero_point = searchInputByIndex(ctx, 5);
    //Onnx__TensorProto *i_y_scale = searchInputByIndex(ctx, 6);
    //Onnx__TensorProto *i_y_zero_point = searchInputByIndex(ctx, 7);
    //Onnx__TensorProto *i_B = searchInputByIndex(ctx, 8);
    ...
    ctx->executer = execute_operator__ai_onnx__qlinearconv__10;
