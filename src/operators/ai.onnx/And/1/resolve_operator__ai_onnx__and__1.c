...
operator_executer
resolve_operator__ai_onnx__and__1(
    node_context *ctx
){
...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__BOOL: { executer = (operator_executer) &execute_operator__ai_onnx__and__1__T_tensor_bool; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__and__1 and constraint 'T' with type '%s' found!\n",operator_info_tensorType2str(T));
        break;
    }
}
}
