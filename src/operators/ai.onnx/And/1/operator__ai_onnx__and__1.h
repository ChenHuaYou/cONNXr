...
/**
 * ai.onnx operator 'And' version 1
 *
 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/logical/old.cc:88
...
} context_operator__ai_onnx__and__1;
...
operator_status
execute_operator__ai_onnx__and__1(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__and__1__T_tensor_bool(
    node_context *ctx
);
