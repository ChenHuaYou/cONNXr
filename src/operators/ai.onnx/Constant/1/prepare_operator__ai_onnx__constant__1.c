...
#include "operator__ai_onnx__constant__1.h"
#include "tracing.h"
#include "utils.h"
...
)
{
    ...
    // context_operator__ai_onnx__constant__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__constant__1));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    // op_ctx->value = a_value->t;
    ...
    // ctx->executer = resolve_operator__ai_onnx__constant__1(ctx);
