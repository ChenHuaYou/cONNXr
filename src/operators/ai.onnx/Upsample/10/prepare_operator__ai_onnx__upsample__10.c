...
)
{
    ...
    // Onnx__TensorProto *i_scales = searchInputByName(ctx, 1);
    ...
    // context_operator__ai_onnx__upsample__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__upsample__10));
    ...
    // ctx->executer = resolve_operator__ai_onnx__upsample__10(ctx);
