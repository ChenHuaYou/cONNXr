...
)
{
    ...
    //Onnx__TensorProto *i_updates = searchInputByIndex(ctx, 2);
    ...
    // context_operator__ai_onnx__scatterelements__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__scatterelements__11));
    ...
    ctx->executer = execute_operator__ai_onnx__scatterelements__11;
