...
)
{
    ...
    // context_operator__ai_onnx__cast__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__cast__1));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    // op_ctx->to = strndup(a_to->s.data, a_to->s.len);
    // TRACE_FATAL(0, !op_ctx->to, "malloc failed");

    // TRACE_VAR(2, true, op_ctx->to, "\"%s\"");
    ...
    // ctx->executer = resolve_operator__ai_onnx__cast__1(ctx);
