 ...
 * @since version 9
 *
 * @see io/onnx/onnx/defs/nn/defs.cc:2010
...
typedef struct {
    ...
    char* mode;
    size_t n_ngram_counts;
    int64_t* ngram_counts;
    size_t n_ngram_indexes;
    int64_t* ngram_indexes;
    size_t n_pool_int64s;
    int64_t* pool_int64s;
    size_t n_pool_strings;
    char** pool_strings;
    size_t n_weights;
    float* weights;
