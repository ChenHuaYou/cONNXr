...
)
{
    ...
    // context_operator__ai_onnx__scatternd__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__scatternd__11));
    ...
    ctx->executer = execute_operator__ai_onnx__scatternd__11;
