...
# ifndef OPERATOR_OPERATOR__AI_ONNX__NEGATIVELOGLIKELIHOODLOSS__12_H
# define OPERATOR_OPERATOR__AI_ONNX__NEGATIVELOGLIKELIHOODLOSS__12_H
...
/**
 * ai.onnx operator 'NegativeLogLikelihoodLoss' version 12
 *
 ...
 * @since version 12
 *
 * @see io/onnx/onnx/defs/math/defs.cc:2167
...
extern operator_info info_operator__ai_onnx__negativeloglikelihoodloss__12;

typedef struct {
    int64_t ignore_index;
    char* reduction;

} context_operator__ai_onnx__negativeloglikelihoodloss__12;
...
operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_double__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_double__Tind_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_float__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_float__Tind_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_float16__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__negativeloglikelihoodloss__12__T_tensor_float16__Tind_tensor_int64(
    node_context *ctx
);
