...
)
{
    ...
    // context_operator__ai_onnx__atan__7 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__atan__7));
    ...
    // ctx->executer = resolve_operator__ai_onnx__atan__7(ctx);
