...
# ifndef OPERATOR_OPERATOR__AI_ONNX__LPPOOL__2_H
# define OPERATOR_OPERATOR__AI_ONNX__LPPOOL__2_H
...
/**
 * ai.onnx operator 'LpPool' version 2
 *
 ...
 * @since version 2
 *
 * @see io/onnx/onnx/defs/nn/old.cc:852
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#LpPool
 */

operator_status
prepare_operator__ai_onnx__lppool__2(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__lppool__2;
...
} context_operator__ai_onnx__lppool__2;
...
operator_status
execute_operator__ai_onnx__lppool__2(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__2__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__2__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__2__T_tensor_float16(
    node_context *ctx
);
