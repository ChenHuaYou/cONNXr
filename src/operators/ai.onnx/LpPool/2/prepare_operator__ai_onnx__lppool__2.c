...
)
{
    ...
    // context_operator__ai_onnx__lppool__2 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__lppool__2));
    ...
    // ctx->executer = resolve_operator__ai_onnx__lppool__2(ctx);
