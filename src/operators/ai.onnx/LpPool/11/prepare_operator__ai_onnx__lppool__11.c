...
)
{
    ...
    // context_operator__ai_onnx__lppool__11 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__lppool__11));
    ...
    // TRACE_VAR(2, true, op_ctx->p, "%" PRId64);
    ...
    // ctx->executer = resolve_operator__ai_onnx__lppool__11(ctx);
