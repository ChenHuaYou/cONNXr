...
# ifndef OPERATOR_OPERATOR__AI_ONNX__LPPOOL__11_H
# define OPERATOR_OPERATOR__AI_ONNX__LPPOOL__11_H
...
/**
 * ai.onnx operator 'LpPool' version 11
 *
 ...
 * @since version 11
 *
 * @see io/onnx/onnx/defs/nn/defs.cc:605
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#LpPool
 */

operator_status
prepare_operator__ai_onnx__lppool__11(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__lppool__11;
...
} context_operator__ai_onnx__lppool__11;
...
operator_status
execute_operator__ai_onnx__lppool__11(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__11__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__11__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__11__T_tensor_float16(
    node_context *ctx
);
