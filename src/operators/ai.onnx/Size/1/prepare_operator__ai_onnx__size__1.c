...
)
{
    ...
    // Onnx__TensorProto *o_size = searchOutputByName(ctx, 0);

    /* ALLOCATE AND INITIALIZE CONTEXT HERE IF NEEDED */

    

    // context_operator__ai_onnx__size__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__size__1));
    ...
    // mallocTensorData(o_size);

    // TRACE_TENSOR(2, true, o_size);

    /* CHOOSE EXECUTER AND CONTEXT HERE */
    /* YOU MAY USE THE GENERATED RESOLVER */

    // ctx->executer = resolve_operator__ai_onnx__size__1(ctx);
