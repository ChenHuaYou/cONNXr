...
)
{
    ...
    // context_operator__ai_onnx__reducemin__12 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__reducemin__12));
    ...
    // ctx->executer = resolve_operator__ai_onnx__reducemin__12(ctx);
