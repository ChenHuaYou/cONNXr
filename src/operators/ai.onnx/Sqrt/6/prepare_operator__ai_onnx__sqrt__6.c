...
)
{
    ...
    // context_operator__ai_onnx__sqrt__6 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__sqrt__6));
    ...
    // ctx->executer = resolve_operator__ai_onnx__sqrt__6(ctx);
