...
)
{
    ...
    //Onnx__TensorProto *i_condition = searchInputByIndex(ctx, 0);
    //Onnx__TensorProto *i_X = searchInputByIndex(ctx, 1);
    //Onnx__TensorProto *i_Y = searchInputByIndex(ctx, 2);
    ...
    // context_operator__ai_onnx__where__9 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__where__9));
    ...
    ctx->executer = execute_operator__ai_onnx__where__9;
