...
)
{
    ...
    // context_operator__ai_onnx__prelu__9 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__prelu__9));
    ...
    // ctx->executer = resolve_operator__ai_onnx__prelu__9(ctx);
