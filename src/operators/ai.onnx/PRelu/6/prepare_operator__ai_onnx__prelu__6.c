...
)
{
    ...
    // Onnx__TensorProto *i_slope = searchInputByName(ctx, 1);

    // TRACE_TENSOR(2, true, i_X);
    // TRACE_TENSOR(2, true, i_slope);
    ...
    // context_operator__ai_onnx__prelu__6 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__prelu__6));
    ...
    // ctx->executer = resolve_operator__ai_onnx__prelu__6(ctx);
