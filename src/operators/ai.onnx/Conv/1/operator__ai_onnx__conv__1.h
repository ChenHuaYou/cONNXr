...
# ifndef OPERATOR_OPERATOR__AI_ONNX__CONV__1_H
# define OPERATOR_OPERATOR__AI_ONNX__CONV__1_H
...
/**
 * ai.onnx operator 'Conv' version 1
 *
 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/nn/old.cc:952
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#Conv
 */

operator_status
prepare_operator__ai_onnx__conv__1(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__conv__1;
...
} context_operator__ai_onnx__conv__1;
...
operator_status
execute_operator__ai_onnx__conv__1(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__1__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__1__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__1__T_tensor_float16(
    node_context *ctx
);
