...
# ifndef OPERATOR_OPERATOR__AI_ONNX__IF__11_H
# define OPERATOR_OPERATOR__AI_ONNX__IF__11_H
...
/**
 * ai.onnx operator 'If' version 11
 *
 ...
 *   shapes.For example, if in a model file, the the first output of
 ...
 * @since version 11
 *
 * @see io/onnx/onnx/defs/controlflow/defs.cc:423
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#If
 */

operator_status
prepare_operator__ai_onnx__if__11(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__if__11;

typedef struct {
    Onnx__GraphProto* else_branch;
    Onnx__GraphProto* then_branch;

} context_operator__ai_onnx__if__11;
...
operator_status
execute_operator__ai_onnx__if__11(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__11__B_tensor_bool(
    node_context *ctx
);
