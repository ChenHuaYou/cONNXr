...
# ifndef OPERATOR_OPERATOR__AI_ONNX__SCAN__8_H
# define OPERATOR_OPERATOR__AI_ONNX__SCAN__8_H
...
/**
 * ai.onnx operator 'Scan' version 8
 *
 ...
 * Input I sequence_lens:
 *   Optional tensor specifying lengths of the sequences in a batch. If this
 *   input is not specified, all sequences are assumed to be of the maximum
 *   sequence length (the dimension of the sequence axis of the scan_input
 *   tensors).
 *   Allowed Types: tensor_int64
 * 
 ...
 * 
 * Attribute INTS directions (optional):
 ...
 * @since version 8
 *
 * @see io/onnx/onnx/defs/controlflow/old.cc:516
...
extern operator_info info_operator__ai_onnx__scan__8;
...
} context_operator__ai_onnx__scan__8;
...
operator_status
execute_operator__ai_onnx__scan__8(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_bool(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_complex128(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_complex64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_int16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_int8(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_uint16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_uint64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__8__I_tensor_int64__V_tensor_uint8(
    node_context *ctx
);
