...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MULTINOMIAL__7_H
# define OPERATOR_OPERATOR__AI_ONNX__MULTINOMIAL__7_H
...
/**
 * ai.onnx operator 'Multinomial' version 7
 *
 ...
 * @since version 7
 *
 * @see io/onnx/onnx/defs/generator/defs.cc:664
...
extern operator_info info_operator__ai_onnx__multinomial__7;
...
} context_operator__ai_onnx__multinomial__7;
...
operator_status
execute_operator__ai_onnx__multinomial__7(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__multinomial__7__T1_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__multinomial__7__T1_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__multinomial__7__T1_tensor_float16(
    node_context *ctx
);
