...
/* operator info */
operator_info
info_operator__ai_onnx__range__11 = {
    .name         = "Range",
    .range_input  = { 3, 3 },
    .range_output = { 1, 1 },
    .n_attribute  = 0,
