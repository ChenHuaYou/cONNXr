...
)
{
    ...
    // context_operator__ai_onnx__slice__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__slice__10));
    ...
    ctx->executer = execute_operator__ai_onnx__slice__10;
