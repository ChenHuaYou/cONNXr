...
)
{
    ...
    // context_operator__ai_onnx__selu__6 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__selu__6));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    // op_ctx->alpha = a_alpha?a_alpha->f:default_alpha;
    // op_ctx->gamma = a_gamma?a_gamma->f:default_gamma;
    ...
    // ctx->executer = resolve_operator__ai_onnx__selu__6(ctx);
