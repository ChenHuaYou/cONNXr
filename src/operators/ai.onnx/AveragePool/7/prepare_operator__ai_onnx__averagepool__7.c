...
)
{
    ...
    // context_operator__ai_onnx__averagepool__7 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__averagepool__7));
    ...
    // ctx->executer = resolve_operator__ai_onnx__averagepool__7(ctx);
