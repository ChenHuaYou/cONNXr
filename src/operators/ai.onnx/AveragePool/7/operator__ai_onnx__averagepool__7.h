...
# ifndef OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__7_H
# define OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__7_H
...
/**
 * ai.onnx operator 'AveragePool' version 7
 *
 ...
 * @since version 7
 *
 * @see io/onnx/onnx/defs/nn/old.cc:411
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#AveragePool
 */

operator_status
prepare_operator__ai_onnx__averagepool__7(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__averagepool__7;
...
} context_operator__ai_onnx__averagepool__7;
...
operator_status
execute_operator__ai_onnx__averagepool__7(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__7__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__7__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__7__T_tensor_float16(
    node_context *ctx
);
