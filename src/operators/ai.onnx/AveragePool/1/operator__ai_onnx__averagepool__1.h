...
# ifndef OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__1_H
# define OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__1_H
...
/**
 * ai.onnx operator 'AveragePool' version 1
 *
 ...
 * @since version 1
 *
 * @see io/onnx/onnx/defs/nn/old.cc:397
...
extern operator_info info_operator__ai_onnx__averagepool__1;
...
} context_operator__ai_onnx__averagepool__1;

operator_executer
resolve_operator__ai_onnx__averagepool__1(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__1(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__averagepool__1__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__1__T_tensor_float16(
    node_context *ctx
);
