...
operator_status
prepare_operator__ai_onnx__averagepool__10(
    node_context *ctx
)
{
    TRACE_ENTRY(1);
    ...
    // int64_t default_count_include_pad = ;
    // size_t default_n_pads = ;
    // int64_t* default_pads = ;
    // size_t default_n_strides = ;
    // int64_t* default_strides = ;

    // context_operator__ai_onnx__averagepool__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__averagepool__10));
    ...
    // op_ctx->count_include_pad = a_count_include_pad?a_count_include_pad->i:default_count_include_pad;
    ...
    // ctx->executer = resolve_operator__ai_onnx__averagepool__10(ctx);
