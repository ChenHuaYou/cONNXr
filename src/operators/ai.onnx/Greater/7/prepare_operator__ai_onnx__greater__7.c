...
)
{
    ...
    // context_operator__ai_onnx__greater__7 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__greater__7));
    ...
    // ctx->executer = resolve_operator__ai_onnx__greater__7(ctx);
