...
)
{
    ...
    // Onnx__AttributeProto *a_paddings = searchAttributeNyName(ctx->onnx_node->n_attribute,ctx->onnx_node->attribute,"paddings");
    ...
    // TRACE_ATTRIBUTE(2, true, a_paddings);
    ...
    // context_operator__ai_onnx__pad__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__pad__1));
    ...
    // op_ctx->n_paddings = a_paddings->n_ints;
    // op_ctx->paddings = a_paddings->ints;
    // op_ctx->value = a_value?a_value->f:default_value;

    // TRACE_VAR(2, true, op_ctx->mode, "\"%s\"");
    // TRACE_ARRAY(2, true, op_ctx->paddings, , op_ctx->n_paddings, "%" PRId64);
    // TRACE_VAR(2, true, op_ctx->value, "%f");
    ...
    // ctx->executer = resolve_operator__ai_onnx__pad__1(ctx);
