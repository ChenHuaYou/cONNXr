...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__INT64: { executer = (operator_executer) &execute_operator__ai_onnx__constantofshape__9__T1_tensor_int64; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__constantofshape__9 and constraint 'T1' with type '%s' found!\n",operator_info_tensorType2str(T1));
        break;
    }
}
}
