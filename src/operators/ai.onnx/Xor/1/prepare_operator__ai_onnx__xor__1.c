...
#include "operator__ai_onnx__xor__1.h"
#include "tracing.h"
#include "utils.h"
...
)
{
    ...
    // context_operator__ai_onnx__xor__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__xor__1));
    ...
    // ctx->executer = resolve_operator__ai_onnx__xor__1(ctx);
