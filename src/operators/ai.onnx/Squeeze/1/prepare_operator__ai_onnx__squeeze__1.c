...
)
{
    ...
    Onnx__TensorProto *o_squeezed = searchOutputByIndex(ctx, 0);
    ...
    // context_operator__ai_onnx__squeeze__1 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__squeeze__1));
    ...
    ctx->executer = execute_operator__ai_onnx__squeeze__1;
