...
#include "operator__ai_onnx__celu__12.h"
...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT: { executer = (operator_executer) &execute_operator__ai_onnx__celu__12__T_tensor_float; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__celu__12 and constraint 'T' with type '%s' found!\n",operator_info_tensorType2str(T));
        break;
    }
}
}
