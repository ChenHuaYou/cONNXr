...
)
{
    ...
    //Onnx__TensorProto *i_y_scale = searchInputByIndex(ctx, 1);
    //Onnx__TensorProto *i_y_zero_point = searchInputByIndex(ctx, 2);
    ...
    // context_operator__ai_onnx__quantizelinear__10 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__quantizelinear__10));
    ...
    ctx->executer = execute_operator__ai_onnx__quantizelinear__10;
